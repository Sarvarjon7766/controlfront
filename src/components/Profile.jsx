		...
		return (
			<div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
				<div className="p-8 bg-white rounded-2xl shadow-lg max-w-md w-full text-center border-2 border-dashed border-indigo-100">
					...
					<p className="text-gray-600 mb-6">Foydalanuvchi ma'lumotlarini yuklashda xatolik yuz berdi</p>
					<button
				...
				<div className="flex flex-col lg:flex-row gap-8">
					...
					<div className="w-full lg:w-2/3">
						<div className="space-y-6">
							{/* Personal Info with Creative Design */}
							<div className="bg-white rounded-2xl shadow-md overflow-hidden">
								...
								<div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
									...
									<div className="flex items-start">
										...
										<div>
											<p className="text-xs text-gray-500 uppercase tracking-wider">Registratsiya sanasi</p>
							...
							{/* Account Status with Creative Design */}
							<div className="bg-white rounded-2xl shadow-md overflow-hidden">
								<div className="bg-gradient-to-r from-indigo-500 to-blue-600 px-6 py-4">
									<h3 className="text-lg font-semibold text-white flex items-center">
										<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
