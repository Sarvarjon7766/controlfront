                  ...
                  `}>
										...
										<td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
											<div className="flex items-center gap-1">
												...
												{user.isEdit && user.lastComment !== null && user.lastCheckOutTime === null && user.lastCheckInTime !== null && (
													<button
										...
										<td className="px-4 py-4 text-sm text-gray-900 whitespace-normal break-words max-w-xs">
											<div className="flex items-center gap-1">
												...
												{user.isEdit && user.lastCheckInTime !== null && user.lastCheckOutTime === null && (
													<button
