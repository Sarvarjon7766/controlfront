						...
						<table className="min-w-full divide-y divide-gray-200">
							<thead className="bg-gray-50">
								<tr>
									...
									<th scope="col" className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Holati</th>
								</tr>
							</thead>
								...
								{getUsersByDepartment(selectedDepartment).length > 0 ? (
									getUsersByDepartment(selectedDepartment).map(user => (
										<tr key={user._id} className="hover:bg-gray-50 transition-colors">
												...
												<div className="flex items-center">
													<div className="flex-shrink-0 h-10 w-10">
														{user.photo ? (
															...
															<div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 flex items-center justify-center text-blue-600 font-medium border border-gray-200">
											...
											<td className="px-5 py-4">
												<span className={`px-3 py-1 inline-flex text-xs leading-5 font-medium rounded-full border ${getStatusClass(user.attendanceStatus)}`}>
